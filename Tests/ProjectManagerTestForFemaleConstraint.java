...
class ProjectManagerTestForFemaleConstraint {
    ...
    @BeforeEach
    void setUp() {
//        Student s1= new Student("ST201","haffaz","mohammad","haffaz@gmail.com","haffaz","haffaz","rmit",3.4,6,'M');
//        ProjectManager.studentsNotInATeam.add(s1);
//        Student s2= new Student("ST202","aamir","khan","aamir@gmail.com","aamir","aamir","rmit",2.7,2,'M');
//        ProjectManager.studentsNotInATeam.add(s2);
//        Student s3= new Student("ST203","nana","patekar","nana@gmail.com","nana","nana","rmit",3.3,1,'M');
//        ProjectManager.studentsNotInATeam.add(s3);
////        Student s4= new Student("ST204","deepika","padukone","deepika@gmail.com","deepika","deepika","rmit",2.5,3,'F');
////        ProjectManager.studentsNotInATeam.add(s4);
//        Student s5= new Student("ST205","shahrukh","khan","shahrukh@gmail.com","shahrukh","shahrukh","rmit",3.2,4,'M');
