...
class ProjectManagerTestForTeamAverageGPAConstraint {
    ...
    static void beforeAll() {
        ...
        teamCreator.add(s1);
        Student s2= new Student("ST202","aamir","khan","aamir@gmail.com","aamir","aamir","rmit",3.5,2,'M');
        teamCreator.add(s2);
        Student s3= new Student("ST203","nana","patekar","nana@gmail.com","nana","nana","rmit",3.5,1,'M');
        teamCreator.add(s3);
        Student s4= new Student("ST204","deepika","padukone","deepika@gmail.com","deepika","deepika","rmit",4,3,'F');
        teamCreator.add(s4);
        ...
        Student s7= new Student("ST207","salman","khan","salman@gmail.com","salman","salman","rmit",3.5,3.5,'M');
    ...
    void teamMemberGPAConstraintApplicatorTest(){
        ...
        teamCreator = ProjectManager.teamAverageGPAConstraintApplicator(teamCreator);

        for(Student student: teamCreator) {
            System.out.println("Name: "+student.getId()+" GPA: "+student.getGpa());
        }
        assertTrue(Constraint.averageGPAHardConstraintCheck(teamCreator));
    }

    @Test
    void teamMemberGPAConstraintApplicatorTestRemaining(){
        teamCreator.clear();
        teamCreator = ProjectManager.teamAverageGPAConstraintApplicator(ProjectManager.studentsNotInATeam);
