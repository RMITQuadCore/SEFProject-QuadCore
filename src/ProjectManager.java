        ...
        do {
            try {
                System.out.println("\n*** Project Manager Menu ***\n" +
                        ...
                        "2. Set Hard & Soft constraints\n" +
                        "3. Enter Weightage for Soft-Constraints\n" +
...
//			}
    ...
    public static void ensureFemaleInATeamandExperienceCheck() {
        tempStudent.addAll(Student.allStudents);
    ...
    public static void personalityConstraintCheck() {
